...
from .forms import PostModleForm ,CommentModelFrom
...
def post_comment_create_list(request):
    ...
    p_form = PostModleForm()
    c_form = CommentModelFrom()
    post_added = False
    ...
    if 'submit_p_form' in request.POST:
        ...
        p_form = PostModleForm(request.POST , request.FILES)
        if p_form.is_valid():
    ...
    if 'submit_c_form' in request.POST:
        c_form = CommentModelFrom(request.POST)
        if c_form.is_valid():
